...
export default async function ExpensesPage({ searchParams }: ExpensesPageProps) {
  ...
  if (!spaceSlug) {
    ...
    const expenseResult = await caller.expenses.listAllSpaces({
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex flex-wrap items-center gap-3">
            <form className="relative flex-1 min-w-[200px]" action={routes.expenses}>
        ...
        <section className="rounded-2xl border border-border bg-surface shadow-sm">
          <div className="hidden border-b border-border px-6 py-3 sm:grid sm:grid-cols-[1fr_80px_100px_100px_120px_80px] sm:gap-4">
            ...
            <div className="divide-y divide-border">
              {expenses.map((expense: any) => (
                <Link
                  ...
                  className="block px-6 py-3.5 transition hover:bg-surface-secondary sm:grid sm:grid-cols-[1fr_80px_100px_100px_120px_80px] sm:items-center sm:gap-4"
                >
            ...
            <div className="px-6 py-16 text-center">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                {hasFilters
                  ...
                  : "Create expenses in a specific space to see them here."}
              </p>
            </div>
          )}
  ...
  const [workspace, categories, expenseResult, monthSummary] = await Promise.all([
    ...
    caller.reporting.expenseMonthSummary({ spaceSlug }),
  ]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          {canManage ? (
            <Link
              href={`${routes.expenses}?modal=add-expense`}
