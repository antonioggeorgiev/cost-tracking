...
export function DebtAccountForm({
  ...
  // Payment schedule state (reuses SchedulePicker from recurring)
    ...
    >
      ...
      <FormSection legend="Details">
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          {showProvider && (
            <div className="grid gap-1.5 sm:col-span-2">
              <Label htmlFor="debt-provider">{kind === DebtAccountKind.leasing ? "Leasing company" : "Lender / Bank"}</Label>
              <Input
                id="debt-provider"
                value={provider}
          ...
          {showCounterparty && (
            <div className="grid gap-1.5 sm:col-span-2">
              <Label htmlFor="debt-counterparty">Person</Label>
              <Input
          ...
          {showTermMonths && (
            <div className="grid gap-1.5">
              <Label htmlFor="debt-term">Term (months)</Label>
              <Input
                id="debt-term"
                type="number"
                min="1"
